...
Linear machines will not be able to find the patters of repeatitions. Alternative patterns.
...
#Notes: Accuracy falls o 68% when we do not standarize the values.
...
print( reg.predict(np.array(123).reshape(1,-1)))
print( reg.predict(np.array(124).reshape(1,-1)))

# Linear Regression or Logistic regression cannot make identify repeative/cycle pattern.
